...
pub const FROND_EXTERN_REGISTRY_LEN: usize = 204;

extern "C" {
    static frond_extern_registry: [*mut core::ffi::c_void; 204];
    static frond_extern_registry_names: [*const core::ffi::c_char; 204];
}
