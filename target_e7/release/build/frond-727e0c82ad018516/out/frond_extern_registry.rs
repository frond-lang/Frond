...
pub const FROND_EXTERN_REGISTRY_LEN: usize = 80;

extern "C" {
    static frond_extern_registry: [*mut core::ffi::c_void; 80];
    static frond_extern_registry_names: [*const core::ffi::c_char; 80];
}
